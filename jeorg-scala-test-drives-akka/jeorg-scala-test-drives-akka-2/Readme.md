...
This module has, as a starting point, the examples provided in the [Akka documentation - Tutorial 2](https://doc.akka.io/docs/akka/current/typed/guide/tutorial_2.html) and [3](https://doc.akka.io/docs/akka/current/typed/guide/tutorial_3.html), under Apache 2.0 licence for version [2.6.15](https://akka.io/blog/news/2021/06/10/akka-2.6.15-released).
